...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <div
      className={`p-10 rounded-2xl bg-surface border border-border-warm border-dashed text-center flex flex-col items-center justify-center space-y-3 ${className}`}
    >
