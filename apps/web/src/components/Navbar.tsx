...
export const Navbar: React.FC = () => {
  ...
  const handleSignOut = async () => {
    try {
      ...
      // Continue to redirect even if network call fails
    }
    router.push("/login");
  };
  ...
  return (
    <header className="sticky top-0 z-50 bg-surface/95 backdrop-blur-md border-b border-border-warm px-3 sm:px-4 md:px-8 py-3 transition-colors">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 pl-2 sm:pl-3 border-l border-border-warm">
            ...
            <button
              ...
              className="p-1.5 rounded-lg text-ink-secondary hover:text-severity-critical hover:bg-severity-critical-bg transition-all cursor-pointer"
            >
